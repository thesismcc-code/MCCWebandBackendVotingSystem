                                        ...
                                        <td class="text-center" style="vertical-align: top;">
                                            <div class="d-flex justify-content-center gap-2">
                                                ...
                                                <button class="btn-action-red"
                                                    title="Delete all candidates in this position"
                                                    data-bs-toggle="modal" data-bs-target="#deleteByPositionModal"
                                                    data-position="{{ $position->getPositionName() }}">
                                                    <svg width="16" height="16" fill="none"
                                                        stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="3" class="text-center text-muted py-4">No candidates found.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" style="max-width: 700px;">
            <div class="modal-content p-2">
                        ...
                        <div class="d-flex align-items-center gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <button type="button" class="btn btn-primary btn-sm px-3"
                                    ...
                                    <svg class="d-inline-block me-1" width="16" height="16" fill="none"
                                        stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="col-sm-9">
                                <select class="form-select" name="position_name" id="addPositionSelect" required>
                                    ...
                                    @foreach ($positions as $position)
                                        <option value="{{ $position->getPositionName() }}">
                ...
                <div class="modal-footer border-0 d-flex justify-content-center gap-3 pb-4">
                    <div class="col-5">
                        <button type="button" class="btn btn-modal-cancel py-2"
                            data-bs-dismiss="modal">Cancel</button>
                    </div>
                    <div class="col-5">
                        <button type="submit" form="addCandidateForm" class="btn btn-modal-save py-2">Add
                            Candidate</button>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" style="max-width: 700px;">
            <div class="modal-content p-2">
                ...
                <div class="modal-footer border-0 d-flex justify-content-center gap-3 pb-4">
                    ...
                    <div class="col-5">
                        <button type="submit" form="editCandidateForm" class="btn btn-modal-save py-2">Save
                            Changes</button>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered" style="max-width: 480px;">
            <div class="modal-content p-2">
                ...
                <div class="modal-body p-4 text-center">
                    ...
                    <p class="fw-bold text-dark" style="font-size: 1.1rem;">"<span id="deleteCandidateName"></span>"?
                    </p>
                ...
                <div class="modal-footer border-0 d-flex justify-content-center gap-3 pb-4">
                    ...
                    <div class="col-5">
                        <button type="submit" form="deleteCandidateForm"
                            class="btn btn-modal-delete py-2">Delete</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered" style="max-width: 480px;">
            <div class="modal-content p-2">
                ...
                <div class="modal-body p-4 text-center">
                    ...
                    <p class="text-dark mb-1" style="font-size: 1rem;">Are you sure you want to delete all candidates
                        under</p>
                    <p class="fw-bold text-dark" style="font-size: 1.1rem;">"<span
                            id="deleteByPositionName"></span>"?</p>
                    <p class="text-secondary" style="font-size: 0.875rem;">This action cannot be undone.</p>
                </div>
                <div class="modal-footer border-0 d-flex justify-content-center gap-3 pb-4">
                    <div class="col-5">
                    ...
                    <div class="col-5">
                        ...
                        --}}
                        <button type="button" class="btn btn-modal-delete py-2" id="confirmDeleteByPosition">Delete
                            All</button>
                    </div>
                </div>
            </div>
